...
// display order: reload > output > compact > editor > keys. returns "" when
// no hint is set. chord (keys) hints are lowest priority — an in-flight
// reload or a mode/action hint wins, since those hints are user-driven and
// recoverable.
